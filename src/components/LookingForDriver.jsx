...
const LookingForDriver = (props) => {
  ...
  return (
    <div className="relative">
      ...
      <div className="mt-8">
        <p className="title-kicker">Matching</p>
        <h3 className="mt-1 mb-6 text-2xl font-bold text-slate-900">
        ...
        <div className="flex justify-center mb-6">
          <div className="relative">
            <img
              className="h-24 p-2 rounded-2xl bg-slate-50 animate-pulse"
              src={vehicleImages[props.vehicleType] || vehicleImages.car}
              alt={props.vehicleType}
            />
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="w-32 h-32 border-4 rounded-full animate-spin border-violet-200 border-t-violet-600"></div>
            </div>
          </div>
        </div>

        <div className="p-4 mb-4 text-center border rounded-2xl border-violet-200 bg-violet-50">
        ...
        <div className="space-y-3">
          <div className="flex items-start gap-4 surface-block">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-slate-700">Pickup</h3>
          ...
          <div className="flex items-start gap-4 surface-block">
            ...
            <div className="flex-1">
              <h3 className="text-sm font-semibold text-slate-700">Fare</h3>
